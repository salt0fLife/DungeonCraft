...
var items= { #[display_name, graphics_path, type_enum, data, 2dImage, set_bonus_key(if applicable)]
	...
	"devil_wings" : ["devil wings", "res://accessories/cape/devil_wings.tscn", itemType.accessories_cape, [[["res://accessories/cape/devil_wings.tscn", 0]], {"can_fly":true,"flying_can_glide":true, "flying_speed":+2.0,"jump_velocity":+2.0, "speed" : +0.25, "vampirism" : 0.25}], ""],
